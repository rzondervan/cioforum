      ...
      child: SafeArea(
        child: Scaffold(
          endDrawer: Responsive.isMobile(context)
              ? SideDrawer(context:context,homeTabSelected:true,productTabSelected:false,newsTabSelected:false,aboutTabSelected:false,contact:false,mission:false,founder:false,partner:false,reference: false,menuKey: menuKey)
              : null,
